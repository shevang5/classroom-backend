 ...
 */
export declare function sensitiveInfo<DetectedEntities extends string | undefined = undefined, ListedEntities extends ArcjetSensitiveInfoType | Exclude<DetectedEntities, undefined> = ArcjetSensitiveInfoType | Exclude<DetectedEntities, undefined>>(options: SensitiveInfoOptions<DetectedEntities, ListedEntities>): Primitive<{
...
export interface Arcjet<Props extends PlainObject> {
     ...
     */
    withRule<ChildProperties extends PlainObject>(rule: Primitive<ChildProperties> | Product<ChildProperties>): Arcjet<Simplify<Props & ChildProperties>>;
}
/**
